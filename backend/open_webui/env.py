...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Fullvio WebUI")
if WEBUI_NAME != "Fullvio WebUI":
    WEBUI_NAME += " WebUI"

WEBUI_FAVICON_URL = "https://github.com/84591486748a47bde1f01f355963135c9561269/images/blob/main/cf-access/favicon.png"
